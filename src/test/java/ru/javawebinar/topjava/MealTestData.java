...
public class MealTestData {
    ...
    public static final int MEAL9_ID = START_SEQ + 10;
    ...
    public static final Meal MEAL7 = new Meal(MEAL7_ID, LocalDateTime.of(2015, Month.MAY, 28, 10, 0), "Завтрак", 510);
    public static final Meal MEAL8 = new Meal(MEAL8_ID, LocalDateTime.of(2015, Month.MAY, 28, 13, 0), "Обед", 500);
    public static final Meal MEAL9 = new Meal(MEAL9_ID, LocalDateTime.of(2015, Month.MAY, 28, 20, 0), "Ужин", 1000);
